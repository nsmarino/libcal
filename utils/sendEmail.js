...
const sendEmail = async (event, email) => {
    const msg = {
      ...
      html: `You have successfully registered for ${event.formData.title}. Please call the library with any further questions. <a href='reedevents.vercel.app/events/${event.id}'>Visit event page</a>`,
    };
